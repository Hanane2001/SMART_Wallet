...
$std = $conn->prepare("SELECT * FROM monthly_limits WHERE idLimit = ? AND idUser = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $str = $conn->prepare("UPDATE monthly_limits SET monthlyLimit = ? WHERE idLimit = ? AND idUser = ?");
    $str->bind_param("dii", $monthlyLimit, $limitId, $userId);
