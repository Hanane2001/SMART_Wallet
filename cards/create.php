...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $std = $conn->prepare("INSERT INTO cards (idUser, cardName, bankName, cardNumber, currentBalance, isMain) VALUES(?,?,?,?,?,?)");
    $std->bind_param("isssdi", $userId, $cardName, $bankName, $cardNumber, $currentBalance, $isMain);
    if($std->execute()){
